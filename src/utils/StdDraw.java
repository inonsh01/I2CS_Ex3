...
/**
 * The {@code StdDraw} class provides static methods for creating drawings with
 * your programs. It uses a simple graphics model that allows you to create
 ...
 * radius is 0.002 and is not affected by coordinate scaling. This default pen
 * radius is about 1/500 the width of the default canvas, so that if you draw
 * 200 points equally spaced along a horizontal or vertical line, you will be
 * able to see individual circles, but if you draw 250 such points, the result
 * will look like a line.
 * <ul>
 * <li>{@link #setPenRadius(double radius)}
 * </ul>
 * <p>
 * For example, {@code StdDraw.setPenRadius(0.01)} makes the thickness of the
 * lines and the size of the points to be five times the 0.002 default. To draw
 ...
 * type, which is defined in Java's {@link java.awt} package. Standard drawing
 * defines a number of predefined colors including {@link #BLACK},
 * {@link #WHITE}, {@link #RED}, {@link #GREEN}, and {@link #BLUE}. For example,
 * {@code StdDraw.setPenColor(StdDraw.RED)} sets the pen color to red.
 * <p>
 * <b>Window title.</b> By default, the standard drawing window title is
 ...
 * also clears the current drawing using the default background color (white).
 * Ordinarily, this method is called only once, at the very beginning of a
 * program. For example, {@code StdDraw.setCanvasSize(800, 800)} sets the canvas
 * size to be 800-by-800 pixels.
 * <p>
 ...
 * degrees counterclockwise or rescale it to fit snugly inside a bounding box.
 * <p>
 * <b>Saving to a file.</b> You can save your image to a file using the <em>File
 * → Save</em> menu option. You can also save a file programmatically using the
 * following method:
 * <ul>
 ...
 *
 * <p>
 * <b>File formats.</b> The {@code StdDraw} class supports reading and writing
 * images to any of the file formats supported by {@link javax.imageio}
 * (typically JPEG, PNG, GIF, TIFF, and BMP). The file extensions corresponding
 * to JPEG, PNG, GIF, TIFF, and BMP, are {@code .jpg}, {@code .png},
 * {@code .gif}, {@code .tif}, and {@code .bmp}, respectively.
 * <p>
 * We recommend using PNG for drawing that consist solely of geometric shapes
 * and JPEG for drawings that contains pictures. The JPEG file format does not
 ...
 * gray. To make the background transparent, call
 * {@code StdDraw.clear(StdDraw.TRANSPARENT)}.
 *
 * <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    /**
     * The shade of blue used in <em>Introduction to Programming in Java</em>. It is
    ...
    /**
     * The shade of red used in <em>Algorithms, 4th edition</em>. It is Pantone
     * 1805U. The RGB values are approximately (150, 35, 31).
     */
    public static final Color BOOK_RED = new Color(150, 35, 31);

    /**
     * The shade of orange used in Princeton University's identity. It is PMS 158.
    ...
    // singleton pattern: EX3_2.client can't instantiate
    private StdDraw() {}
     ...
     *
     * @param isVisible if {@code true}, makes the drawing window visible, otherwise
    ...
    /**
     * Sets the canvas (drawing area) to be 512-by-512 pixels. This also clears the
     * current drawing using the default background color (white). Ordinarily, this
     ...
     * pixels. This also clears the current drawing using the default background
     * color (white). Ordinarily, this method is called once, at the very beginning
     * of a program.
     *
    ...
    /**
     * Closes the standard drawing window. This allows the EX3_2.client program to
     * terminate instead of requiring the user to close the standard drawing window
     * manually. Drawing after calling this method will restore the previous window
     * state.
     */
    ...
    /**
     * Clears the screen using the specified background color. To make the
     * background transparent, use {@code StdDraw.TRANSPARENT}.
     *
     ...
     * <p>
     * There are a number predefined pen colors, such as {@code StdDraw.BLACK},
     * {@code StdDraw.WHITE}, {@code StdDraw.RED}, {@code StdDraw.GREEN}, and
     * {@code StdDraw.BLUE}.
     *
     ...
     * image formats are typically JPEG, PNG, GIF, TIFF, and BMP. As an
     * optimization, the picture is cached, so there is no performance penalty for
     * redrawing the same image multiple times (e.g., in an animation). However, if
     * you change the picture file after drawing it, subsequent calls will draw the
     * original picture.
     *
    ...
    /**
     * Saves the drawing to a file in a supported file format (typically JPEG, PNG,
     * GIF, TIFF, and BMP). The filetype extension must be {@code .jpg},
     * {@code .png}, {@code .gif}, {@code .bmp}, or {@code .tif}.
     *
